...
SELECT app_name, last_updated FROM analytics GROUP BY app_name,last_updated ORDER BY MIN(last_updated) LIMIT 1; 
-- 12. Find the most expensive app (the query is very similar to #11).
SELECT app_name, price FROM analytics GROUP BY app_name,price ORDER BY MAX(price) DESC LIMIT 1; 
